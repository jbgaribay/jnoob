...
export default function WaiverWire({ data, settings }: { data: LeagueData; settings: UserSettings }) {
  void data; void settings;
  return (
    <div className="flex items-center justify-center h-64">
      <div className="text-center">
        <div className="text-2xl font-black mb-2" style={{ color: "var(--accent)" }}>Waiver Wire</div>
